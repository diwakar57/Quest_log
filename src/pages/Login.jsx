        ...
        {status === 'sent' ? (
          ...
          <div className="mt-6 space-y-4">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded border border-slate-600 bg-white px-4 py-2 font-medium text-slate-900 hover:bg-slate-100 disabled:opacity-50"
            >
